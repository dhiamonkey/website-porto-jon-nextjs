  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Lewis - Creative Portfolio HTML Template"
        />
            ...
            <header id="header" className="header header-fixed">
                ...
                <div className="header-content d-none d-md-block">
                  <div className="header-contacts">
                    ...
                    <div className="header-contact-item">
                      <a
                        href="https://api.whatsapp.com/send/?phone=6281513933509&text&app_absent=0"
                        target="_blank"
                    ...
                    <div className="header-contact-item">
                      <a
                        href="mailto:dhiamuhammad@gmail.com"
                        className="mail-link"
                      >
                        dhiamuhammad@gmail.com
                      </a>
                    </div>
                  </div>
                </div>
              ...
              <div className="menu">
                <div className="menu-lang">
                  ...
                  <a href="#" className="menu-lang-item" onClick={soonID}>
                    Indonesian
                  </a>
                  <a href="#" className="menu-lang-item" onClick={soonSD}>
                    Sundanese
                  </a>
                  <a href="#" className="menu-lang-item" onClick={soonNL}>
                    Dutch
                  </a>
                </div>
                ...
                <div className="menu-main" id="accordion">
                  <ul>
                    ...
                    <li
                      className={
                        router.pathname === "/aspiring-content"
                          ? "active"
                          : router.pathname === "/selling-content"
                          ? "active"
                          : router.pathname === "/other-works"
                          ? "active"
                          : "false"
                      }
                    >
                      ...
                      >
                        <ul>
                          ...
                          >
                            <a
                              href="/aspiring-content"
                              className="animsition-link"
                              data-animsition-out-class="fade-out"
                              data-text="Aspiring Contents"
                            >
                              Aspiring Contents
                            </a>
                          </li>
                          ...
                          <li
                            className={
                              router.pathname === "/other-works" ? "active" : ""
                            }
                          >
                            <a
                              href="/other-works"
                    ...
                    <li
                      className={
                        router.pathname === "/about-me" ? "active" : ""
                      }
                    >
                      <a
                        data-text="About Me &amp; CV"
                        href="about-me"
                        role="button"
                        aria-expanded="false"
                ...
                <div className="menu-footer">
                  <ul className="social social-rounded">
                    <li>
                      <a
                        href="https://www.linkedin.com/in/dhia-rizqullah/"
                        target="blank"
                      >
                    ...
                    <li>
                      <a href="https://github.com/dhiamonkey" target="blank">
                        <i className="socicon-github"></i>
                      </a>
                    </li>
                    <li>
                      <a
                        href="https://www.behance.net/dhiamuhammad"
                        target="blank"
                      >
